...
>#### Create a Test file in test directory which checks if the root endpoint (/) returns the expected message  <br><br>
...
>#### Add AWS credentials as environment variables in Terraform Cloud workspace.    <br><br>
